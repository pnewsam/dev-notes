...
https://www.teamblind.com/post/New-Year-GiftCurated-List-of-Top-75-LeetCode-Questions-to-Save-Your-Time-OaM1orEU

## Array

1. Two Sum - [Leetcode](https://leetcode.com/problems/two-sum/)
1. Best Time to Buy and Sell Stock - [Leetcode](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)
1. Contains Duplicate - [Leetcode](https://leetcode.com/problems/contains-duplicate/)
1. Product of Array Except Self - [Leetcode](https://leetcode.com/problems/product-of-array-except-self/)
1. Maximum Subarray - [Leetcode](https://leetcode.com/problems/maximum-subarray/)
1. Maximum Product Subarray - [Leetcode](https://leetcode.com/problems/maximum-product-subarray/)
1. Find Minimum in Rotated Sorted Array - [Leetcode](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/)
...
1. Container With Most Water - [Leetcode](https://leetcode.com/problems/container-with-most-water/)
